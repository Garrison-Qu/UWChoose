...
export const courses: Course[] = [
  ...
  },
  {
    ...
    prerequisiteRawText: "Complete all of the followingStudents must be in level 4A or higherEnrolled in H-Data Science (BMath)"
  },
  {
    code: "ECE124",
  ...
  },
  {
    ...
    prerequisiteRawText: "Complete all of the followingStudents must be in level 4A or higherEnrolled in Society, Technology & Values Option"
  },
  {
    code: "STV401",
